...
In development since 2021, Rollkit is now emerging as neutral and independent from Celestia. Rollkit will serve as a community-led public good for the modular ecosystem going forward, with its own docs at [rollkit.dev](/).
...
You can find the original blog post [here](https://blog.celestia.org/p/f36529f7-8ecc-469e-b602-11284b7eb1a4/).
