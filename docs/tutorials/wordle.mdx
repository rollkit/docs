...
* [GM World](./gm-world.mdx) or [Hello, World](https://docs.ignite.com/guide/hello/scaffolding)
* [Recipe Book](./recipe-book.mdx) or [Blog and Module Basics](https://docs.ignite.com/guide/blog/intro)
...
```bash
go mod edit -replace github.com/cosmos/cosmos-sdk=github.com/rollkit/cosmos-sdk@v0.46.13-rollkit-v0.8.1-fix-no-fraud-proofs
...
```bash
go mod edit -replace github.com/cosmos/cosmos-sdk=github.com/rollkit/cosmos-sdk@v0.46.13-rollkit-v0.8.2-rc0-no-fraud-proofs
go mod edit -replace github.com/tendermint/tendermint=github.com/rollkit/cometbft@v0.0.0-20230524013049-75272ebaee38
go mod tidy
go mod download
```
