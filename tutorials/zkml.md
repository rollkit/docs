...
In this guide, we will deploy the circuit on Sindri, obtain a smart contract verifier (automatically generated by Sindri) for that circuit, deployed it on Rollkit, create a proof of ML inference on Sindri, and verify the proof on-chain.
